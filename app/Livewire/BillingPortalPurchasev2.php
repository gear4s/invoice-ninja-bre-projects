...
class BillingPortalPurchasev2 extends Component
{
    ...
    public function handleBeforePaymentEvents(): self
    {
        ...
        $this->payable_amount = $invoice->partial > 0 ? Number::formatValue($invoice->partial, $invoice->client->currency()) : Number::formatValue($invoice->balance, $invoice->client->currency());

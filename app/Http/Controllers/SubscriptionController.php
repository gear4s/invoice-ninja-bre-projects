...
class SubscriptionController extends BaseController
{
     ...
     *     )
     */
    public function index(SubscriptionFilters $filters): Response
    {
     ...
     *     )
     */
    public function create(CreateSubscriptionRequest $request): Response
    {
        /** @var User $user */
        $user = auth()->user();
     ...
     *     )
     */
    public function show(ShowSubscriptionRequest $request, Subscription $subscription): Response
    {
        return $this->itemResponse($subscription);
    }
     ...
     *     )
     */
    public function edit(EditSubscriptionRequest $request, Subscription $subscription): Response
    {
        return $this->itemResponse($subscription);
    }
     ...
     *     )
     */
    public function destroy(DestroySubscriptionRequest $request, Subscription $subscription): Response
    {

...
{
    public function index(string $entity, string $invitation_key, Request $request): View
    {
    ...
    public function update(string $entity, string $invitation_key, Request $request): RedirectResponse
    {
        $class = '\\App\\Models\\' . ucfirst(Str::camel($entity)) . 'Invitation';

...
class CheckDataTest extends TestCase
{
    ...
    public function test_db_queries_raw5()
    {
        $this->buildData();
        ...
        Payment::with('paymentables')->cursor()->each(function ($payment) {
            $this->assertNotNull($payment->paymentables()->where('paymentable_type', Credit::class)->get()
    ...
    public function test_db_queries_raw4()
    {
        $this->buildData();
    ...
    public function test_db_queries_raw3()
    {
        $this->buildData();
    ...
    public function test_db_raw_queries1()
    {
        $this->buildData();
    ...
    public function test_db_raw_queries2()
    {
        $this->buildData();

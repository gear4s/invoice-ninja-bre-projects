...
class SumTaxTest extends TestCase
{
    ...
    public function test_calc_invoice_no_tax()
    {
    ...
    public function test_calc_invoice_tax()
    {
    ...
    public function test_tax_on_company()
    {
    ...
    public function test_tax_on_client()
    {
    ...
    public function test_tax_on_invoice()
    {
    ...
    public function test_sum_of_invoice()
    {
    ...
    public function test_sum_of_taxes()
    {
        $sum =

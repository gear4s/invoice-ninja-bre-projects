...
class TaskApiTest extends TestCase
{
    ...
    public function test_task_creation_and_client_linking_by_email()
    {
    ...
    public function test_time_log_validation_with5_elements_post_time_log_boolean_passes()
    {
    ...
    public function test_time_log_validation_with5_elements_post_time_log_boolean()
    {
    ...
    public function test_time_log_validation_with5_elements_post()
    {
    ...
    public function test_time_log_validation_with5_elements_put()
    {
    ...
    public function test_put_task_time_log()
    {
    ...
    public function test_task_log_generationfor_invoices()
    {
    ...
    public function test_bad_request_case_one()
    {
    ...
    public function test_time_log_with_same_start_and_stop_times()
    {
    ...
    public function test_rounding_via_api()
    {
    ...
    public function test_rounding_to_nearest_xxx()
    {
    ...
    public function test_ksort_performance()
    {
        $logs = [
    ...
    public function test_task_division_by_zero()
    {
        $data = [
            'rate' => 0,
    ...
    public function test_request_rule_parsing()
    {
    ...
    public function test_empty_time_log_array()
    {
    ...
    public function test_faulty_time_log_array()
    {
    ...
    public function test_task_client_rate_set()
    {
        $settings = ClientSettings::defaults();
        $settings->default_task_rate = 41;
    ...
    public function test_task_timelog_parse()
    {
        $data = [
            'description' => 'xx',
            'rate' => '6574',
    ...
    public function test_task_project_rate_set()
    {
    ...
    public function test_status_set()
    {
    ...
    public function test_start_date()
    {
        ...
        $this->assertNotNull(Carbon::createFromTimestamp($x[0][0]));

    }

    public function test_multi_sort_array()
    {
    ...
    public function test_start_stop_sanity()
    {
    ...
    public function test_stopping_task_with_description()
    {
        $task = Task::factory()->create([
            'client_id' => $this->client->id,
            'user_id' => $this->user->id,
    ...
    public function test_multi_dimension_array_of_times()
    {
        $logs = [
            '[[1680302433,1680387960,"",true]]',
    ...
    public function test_array_of_times()
    {
        $logs = [
    ...
    public function test_time_log_checker1()
    {
        $log = [
            [50, 0],
        ];
    ...
    public function test_time_log_checker2()
    {
        $log = [
            [4, 5],
            [5, 1],
    ...
    public function test_time_log_checker3()
    {
        $log = [
            [4, 5],
            [3, 50],
    ...
    public function test_time_log_checker4()
    {
        $log = [
            [4, 5],
            [3, 0],
    ...
    public function test_time_log_checker5()
    {
        $log = [
            [4, 5],
            [3, 1],
    ...
    public function test_time_log_checker6()
    {
        $log = [
            [4, 5],
            [1, 3],
    ...
    public function test_time_log_checker7()
    {
        $log = [
            [1, 3],
            [4, 5],
    ...
    public function test_time_log_checker8()
    {
        $log = [
            [1, 3],
            [50, 0],
    ...
    public function test_time_log_checker9()
    {
        $log = [
            [4, 5, 'bb'],
            [50, 0, 'aa'],
    ...
    public function test_time_log_checker10()
    {
        $log = [
            [4, 5, '5'],
            [50, 0, '3'],
    ...
    public function test_time_log_checker11()
    {
        $log = [
            [1, 2, 'a'],
            [3, 4, 'd'],
    ...
    public function test_time_log_checker12()
    {
        $log = [
            [1, 2, 'a', true],
            [3, 4, 'd', false],
    ...
    public function test_task_list_with_projects()
    {
    ...
    public function test_task_list_client_status()
    {
        $response = $this->withHeaders([
            'X-API-SECRET' => config('ninja.api_secret'),
            'X-API-TOKEN' => $this->token,
    ...
    public function test_task_locking_gate()
    {
        $data = [
            'timelog' => [[1, 2, 'a'], [3, 4, 'd']],
        ];
    ...
    public function test_time_log_validation()
    {
        $data = [
    ...
    public function test_time_log_validation1()
    {
        $data = [
            'timelog' => [[1, 2], [3, 4]],
        ];
    ...
    public function test_time_log_validation2()
    {
        $data = [
            'timelog' => [],
        ];
    ...
    public function test_time_log_validation3()
    {
        $data = [
    ...
    public function test_time_log_validation4()
    {
        $data = [
            'timelog' => [[1, 2, 'd'], [3, 0, 'd']],
        ];
    ...
    public function test_task_post()
    {
        $data = [
    ...
    public function test_task_post_no_defined_task_number()
    {
        $data = [
            'description' => $this->faker->firstName(),
        ];
    ...
    public function test_task_with_bad_client_id()
    {
        $data = [
    ...
    public function test_task_post_with_action_start()
    {
        $data = [
            'description' => $this->faker->firstName(),
        ];
    ...
    public function test_tasks_get()
    {
        $response = $this->withHeaders([
            'X-API-SECRET' => config('ninja.api_secret'),
            'X-API-TOKEN' => $this->token,
    ...
    public function test_task_not_archived()
    {
        $response = $this->withHeaders([
            'X-API-SECRET' => config('ninja.api_secret'),
            'X-API-TOKEN' => $this->token,
    ...
    public function test_task_archived()
    {
        $data = [
    ...
    public function test_task_restored()
    {
        $data = [
            'ids' => [$this->encodePrimaryKey($this->task->id)],
        ];
    ...
    public function test_task_post_with_start_action()
    {
        $data = [
            'description' => $this->faker->firstName(),
            'number' => 'taskynumber2',
    ...
    public function test_task_post_with_stop_action()
    {
        $data = [
            'description' => $this->faker->firstName(),
        ];

...
class BankTransactionRuleTest extends TestCase
{
    ...
    public function test_new_credit_matching_rules_invoice_starts_with()
    {
    ...
    public function test_new_credit_matching_rules_invoice_contains()
    {
    ...
    public function test_new_credit_matching_rules_invoice_number()
    {
    ...
    public function test_new_credit_matching_rules_invoice_amount()
    {
    ...
    public function test_new_credit_matching_rules_payment_custom_value()
    {
    ...
    public function test_new_credit_matching_rules_payment_starts_with()
    {
    ...
    public function test_new_credit_matching_rules_payment_amount()
    {
    ...
    public function test_new_credit_matching_rules_payment_transaction_reference_exact_match()
    {
    ...
    public function test_new_credit_matching_rules_payment_transaction_reference_contains()
    {
    ...
    public function test_match_credit_on_invoice_number()
    {
    ...
    public function test_matching_with_stripos()
    {
    ...
    public function test_bank_rule_bulk_actions()
    {
        $data = [
            'action' => 'archive',
    ...
    public function test_validation_contains_rule()
    {
        $bi = BankIntegration::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense_amount_less_than_equal_to()
    {
        $bi = BankIntegration::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense_amount_less_than()
    {
        $br = BankTransactionRule::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense_amount_greater_than()
    {
        $br = BankTransactionRule::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense_amount_miss()
    {
        $br = BankTransactionRule::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense_amount()
    {
        $br = BankTransactionRule::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense_is_empty()
    {
        $br = BankTransactionRule::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense_is_empty_miss()
    {
        $bi = BankIntegration::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense_starts_with_miss()
    {
        $br = BankTransactionRule::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense_starts_with()
    {
        $br = BankTransactionRule::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense_contains_miss()
    {
        $br = BankTransactionRule::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense_contains()
    {
        $br = BankTransactionRule::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense_miss()
    {
        $br = BankTransactionRule::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,
    ...
    public function test_matching_bank_transaction_expense()
    {
        $br = BankTransactionRule::factory()->create([
            'company_id' => $this->company->id,
            'user_id' => $this->user->id,

...
class BankTransactionTest extends TestCase
{
    ...
    public function test_bank_integration_filters()
    {
    ...
    public function test_link_multiple_expenses_with_delete_to_transaction()
    {
        $data = [];
    ...
    public function test_link_multiple_expenses_to_transaction()
    {
        $data = [];
    ...
    public function test_bank_transaction_bulk_actions()
    {
        $data = [
    ...
    public function test_link_expense_to_transaction()
    {
        $data = [];
    ...
    public function test_linking_manually_paid_invoices()
    {
    ...
    public function test_link_payment_to_transaction()
    {
        $data = [];
    ...
    public function test_match_bank_transactions_validation_should_fail()
    {
        $data = [];
    ...
    public function test_match_bank_transaction_validation_should_pass()
    {

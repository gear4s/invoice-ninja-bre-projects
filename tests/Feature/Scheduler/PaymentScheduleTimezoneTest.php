...
class PaymentScheduleTimezoneTest extends TestCase
{
     ...
     */
    public function test_old_algorithm_fails_for_new_york_timezone(): void
    {
     ...
     */
    public function test_both_algorithms_work_when_days_align(): void
    {
     ...
     */
    public function test_start_of_day_nullifies_offset(): void
    {
     ...
     */
    public function test_offset_to_now_preserves_day_context(): void
    {
     ...
     */
    public function test_payment_schedule_with_positive_offset_for_west_timezone(): void
    {
     ...
     */
    public function test_payment_schedule_with_negative_offset_for_east_timezone(): void
    {

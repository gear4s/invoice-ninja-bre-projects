...
class PeppolTest extends TestCase
{
    ...
    public function test_be_to_be_with_special_line_item_configuration()
    {
    ...
    public function test_invoice_period_validation()
    {
    ...
    public function test_invoice_validation_with_small_discount()
    {
        $scenario = [
            'company_vat' => 'DE923356489',
            'company_country' => 'DE',
    ...
    public function test_entity_validation_fails_for_invoice_via_invoice()
    {
        $scenario = [
            'company_vat' => 'DE923356489',
            'company_country' => 'DE',
    ...
    public function test_entity_validation_fails_for_client_via_client()
    {
        $scenario = [
            'company_vat' => 'DE923356489',
            'company_country' => 'DE',
    ...
    public function test_entity_level_directly_validates_client_with_missing_address()
    {
        $scenario = [
            'company_vat' => 'DE923356489',
            'company_country' => 'DE',
     ...
     */
    public function test_vat_number_validation_with_valid_formats()
    {
        $validVatNumbers = [
     ...
     */
    public function test_vat_number_validation_with_invalid_formats()
    {
        $invalidVatNumbers = [
     ...
     */
    public function test_vat_number_validation_skipped_for_individuals_and_government()
    {
     ...
     */
    public function test_vat_number_required_for_business_in_eu()
    {
        $scenario = [
            'company_vat' => 'DE923356489',
            'company_country' => 'DE',
     ...
     */
    public function test_vat_number_validation_with_special_characters()
    {
        $testCases = [
    ...
    public function test_entity_validation_fails_for_client_via_invoice()
    {
        $scenario = [
            'company_vat' => 'DE923356489',
            'company_country' => 'DE',
    ...
    public function test_entity_validation_fails_for_company()
    {
        $scenario = [
            'company_vat' => 'DE923356489',
            'company_country' => 'DE',
    ...
    public function test_entity_validation_should_fail_for_fr_business()
    {
        $scenario = [
            'company_vat' => 'DE923356489',
            'company_country' => 'DE',
    ...
    public function test_with_chaos_monkey()
    {
        ...
        foreach ($scenarios as $scenario) {
            ...
            $validator = new XsltDocumentValidator($p->toXml());
            $validator->validate();
    ...
    public function test_de_invoice_intra_community_supply()
    {
    ...
    public function test_de_invoice_single_invoice_surcharge()
    {
    ...
    public function test_de_invoice_percent_discounts()
    {
    ...
    public function test_de_invoice_level_and_item_level_percentage_discount()
    {
    ...
    public function test_de_invoice_level_percentage_discount()
    {
    ...
    public function test_de_invoice_amount_and_item_amount_discounts()
    {
    ...
    public function test_de_invoice_amount_discounts()
    {
    ...
    public function test_de_invoice()
    {
    ...
    public function test_de_invoice_inclusive_taxes()
    {

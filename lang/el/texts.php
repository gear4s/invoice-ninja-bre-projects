...
<li>"Προκαταβολή πληρωμής για το :QUARTER+1" >> "Προκαταβολή πληρωμής για το Τρίμηνο 2"</li>
    ...
    'downgrade_to_free_description' => 'Υποβάθμιση στο δωρεάν πρόγραμμα. Λάβετε υπόψη ότι αυτό θα καταργήσει όλες τις λειτουργίες επί πληρωμή από τον λογαριασμό σας.',
